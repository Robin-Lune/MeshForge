...
// Défaut prudent : seule une valeur FALSE explicite, posée par un admin pour un
// relais fixe, autorise l'affichage exact. Une ancienne ligne NULL reste floutée
// même avant l'application de la migration NOT NULL.
